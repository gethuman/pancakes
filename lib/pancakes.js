 ...
 */
var requireModule = function (filePath, refreshFlag) {
    if (refreshFlag) {
...
/**
 * Destroys the injector instance by setting the value to null. 
 * Used for catching initiliazation error (init() not called yet)
 * 
 */
...
/**
 * Helper function to return the injector for testing purpose
 * @returns {*}
*/
