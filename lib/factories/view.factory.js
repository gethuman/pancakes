 ...
 * @param moduleStack
 */
ViewFactory.prototype.getPartial = function (appName, moduleStack) {
    var me = this;
    ...
    return function (partialName, model) {
        ...
        var deps = { parentModel: model };
        var opts = { flapjack: partial.serverView, dependencies: deps, app: appName, type: 'view' };
...
ViewFactory.prototype.create = function (modulePath, moduleStack, options) {
    var partialDep = { partial: this.getPartial(options.app, moduleStack) };
    var deps = _.extend({}, options.dependencies, partialDep);
