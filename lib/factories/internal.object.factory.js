...
/*
InternalObjectFactory.prototype.loadServices = function () {
    var resources = this.internalObjects.resources || this.loadResources();
    var services = {};
    var me = this;

    _.each(resources, function (resource) {
        var serviceName = utils.getCamelCase(resource.name + '.service');
        services[serviceName] = me.injector.loadModule(serviceName);
    });
...
InternalObjectFactory.prototype.create = function (objectName) {
    ...
    /*
    else if (objectName === 'services' && this.internalObjects[objectName] === true) {
        this.internalObjects[objectName] = this.loadServices();
    }
    */
