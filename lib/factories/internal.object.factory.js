...
InternalObjectFactory.prototype.loadResources = function () {
    var resources = {};
    var resourcesDir = p.join(this.injector.rootDir, this.injector.servicesDir + '/resources');
...
InternalObjectFactory.prototype.loadAdapters = function () {
    var adapters = {};
    var adaptersDir = p.join(this.injector.rootDir, this.injector.servicesDir + '/adapters');
...
InternalObjectFactory.prototype.loadReactors = function () {
    var reactors = {};
    var reactorsDir = p.join(this.injector.rootDir, this.injector.servicesDir + '/reactors');
 ...
 * @returns {{}}
 */
InternalObjectFactory.prototype.loadAppConfigs = function () {
    var appConfigs = {};
    var appDir = p.join(this.injector.rootDir, '/app');
