...
_.extend(FlapjackFactory.prototype, {
    ...
    injectFlapjack: function injectFlapjack(flapjack, moduleStack, options) {
        ...
        _.each(params, function (param) {
            ...
            try
            {
                paramModules.push(dep || deps[param] || me.injector.loadModule(param, moduleStack));
            }
            catch (ex) {
    ...
    create: function create(modulePath, moduleStack, options) {
        ...
        if (options && options.flapjack) {
            return this.injectFlapjack(options.flapjack, moduleStack, options);
        }
        ...
        this.cache[modulePath] = this.injectFlapjack(flapjack, moduleStack, options);
        return this.cache[modulePath];
    }
});
