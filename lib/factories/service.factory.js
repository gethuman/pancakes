 ...
 * @returns {*}
 */
ServiceFactory.prototype.validateRequestParams = function (req, resource, method, adapter) {
    req = req || {};
    ...
    var validParams = requiredParams.concat(eitherorParams, optional, ['lang', 'caller', 'resource', 'method', 'auth', 'noemit']);
    for (var key in req) {
