...
var transform = function (flapjack, options) {
    ...
    // if client controller exists, get values for controller
    if (flapjack.clientController) {
        model.controllerExists = true;

        aliases = annotHelper.getClientAliases(flapjack.clientController) || {};
        _.extend(aliases, { _: 'angular', Q: '$q' });

        params = annotHelper.getParameters(flapjack.clientController) || {};
        ...
        model.body = transHelper.getModuleBody(flapjack.clientController);
