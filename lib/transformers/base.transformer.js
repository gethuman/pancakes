 ...
 * @returns {String}
 */
function getAppModuleName(ngPrefix, appName) {
    return this.getCamelCase(ngPrefix + '.' + appName + '.app');
}
 ...
 * @param templateName
 */
function setTemplate(transformDir, templateName) {
    if (templateCache[templateName]) {
        this.template = templateCache[templateName];
    }
    else {
        var fileName = transformDir + '/ng.' + templateName + '.template';
