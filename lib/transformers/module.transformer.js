 ...
 */
var transform = function (injector, filePath, options) {
    ...
    var transformer = require('./' + options.clientType + '.' + options.transformer + '.transformer');
    return transformer.transform(injector, flapjack, options);
};
